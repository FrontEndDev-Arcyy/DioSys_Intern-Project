...
import CommunionTable from '../views/contents/SacramentsPage/CommunionRecords/CommunionTable';
import CommunionModal from '../views/contents/SacramentsPage/CommunionRecords/CommunionModal';
      ...
      <Header style={{ padding: 0, backgroundColor: 'white', lineHeight: '64px' }}>
        ...
        <Content style={{ margin: '0 16px' }}>
            <Breadcrumb style={{ margin: '16px 0' }}>
                ...
                <Breadcrumb.Item>Communion Records</Breadcrumb.Item>
            </Breadcrumb>
