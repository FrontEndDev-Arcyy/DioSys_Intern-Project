...
import VenueTable from '../views/contents/Venue/VenueTable';
import VenueModal from '../views/contents/Venue/VenueModal';
      ...
      <Header style={{ padding: 0, backgroundColor: 'white', lineHeight: '64px' }}>
        ...
        <Content style={{ margin: '0 16px' }}>
            <Breadcrumb style={{ margin: '16px 0' }}>
                ...
                <Breadcrumb.Item><Link to="">Venue</Link></Breadcrumb.Item>
            </Breadcrumb>
